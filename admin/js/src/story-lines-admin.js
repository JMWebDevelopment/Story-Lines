jQuery( document ).ready( function( $ ) {
	...
	$( '#story_lines_title_background' ).wpColorPicker();
	$( '#story_lines_main_background' ).wpColorPicker();
	$( '#story_lines_title_color' ).wpColorPicker();
	$( '#story_lines_main_color' ).wpColorPicker();
} );
